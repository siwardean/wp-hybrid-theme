...
<div id="page" class="site">
	<header id="masthead" class="site-header">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'hybrid_theme' ); ?></a>
		...
		<div class="header-container">
			...
			<div class="site-branding">
				...
				<?php
				$hybrid_theme_description = get_bloginfo( 'description', 'display' );
				if ( $hybrid_theme_description || is_customize_preview() ) :
					?>
					<div class="site-description"><?php echo $hybrid_theme_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
				<?php endif; ?>
			</div><!-- .site-branding -->
