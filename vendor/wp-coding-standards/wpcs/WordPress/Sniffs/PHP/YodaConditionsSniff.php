...
final class YodaConditionsSniff extends Sniff {
	...
	public function register() {
		...
		$hybrid_themes                        = Tokens::$booleanOperators;
		$hybrid_themes                       += Tokens::$assignmentTokens;
		$hybrid_themes[ \T_CASE ]             = \T_CASE;
		$hybrid_themes[ \T_RETURN ]           = \T_RETURN;
		$hybrid_themes[ \T_INLINE_THEN ]      = \T_INLINE_THEN;
		$hybrid_themes[ \T_INLINE_ELSE ]      = \T_INLINE_ELSE;
		$hybrid_themes[ \T_SEMICOLON ]        = \T_SEMICOLON;
		$hybrid_themes[ \T_OPEN_PARENTHESIS ] = \T_OPEN_PARENTHESIS;

		$this->condition_start_tokens = $hybrid_themes;
